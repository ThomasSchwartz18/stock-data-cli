...
My coding journey began six years ago when Stack Overflow was the primary go-to resource for solving any bugs. I feel fortunate to have learned programming fundamentals back when it often meant writing everything manually. My exploration into AI assisted coding started a few months after the release of ChatGPT, initially just using the LLM to help solve error codes. Fast forward to today, and I've developed a comprehensive system using a personal collection of markdown files to direct AI agents, effectively creating a 'markdown brain' that runs my development workflow. My biggest initial challenge with AI was dealing with the unorganized code it sometimes produced. When relying on it without strict guidelines, it steered me towards messy, tightly coupled code structures that made the application incredibly difficult to scale. This was a hiccup I overcame by creating this structured, prompt-driven system over the last year and a half.

For this specific project, AI played a big role in the planning stages. I guided it through a series of prompts to break down the project into the distinct, manageable phases you can see in the `docs/plans/` directory. This structured approach, where I review and refine a step-by-step plan before execution, was critical. I also used the agent to create a `CHANGELOG` to track historical decisions for future reference and had it apply UI touch-ups based on the project's guidelines. This workflow provides a clear and efficient path from concept to implementation.
*
